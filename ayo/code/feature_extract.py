...
The command is:     python feature_extract.py mobile model/mobile_Animals_wgt.h5

The second parameter is the model weight.
The extracted features will be saved at 'features_mobile.pickle'
"""
...
def main():
    ...
    # The constants
    classNum = {'m': 190, 'A': 40, 'F': 40, 'V': 40, 'E': 40, 'H': 24}
    ...
    imgdir_train = imgdir_train = 'trainval_'+superclass+'/train'
    imgdir_test = '/media/hszc/data1/syh/zhijiang/ZJdata/DatasetA_test_20180813/DatasetA_test/test224'
